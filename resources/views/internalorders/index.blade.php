            ...
            <div class="col-md-2">
                ...
                <button type="reset" class="btn btn-warning" data-toggle="tooltip" id="reset_form"
                 ...
                 <div class="float-right">
                    <a class="btn btn-xs btn-primary" href="{{ route('internalorder.create') }}">
                        <img src="{{ asset('icons/addicon.svg') }}" alt="">
                        Internal Order </a>
                        <a href="{{ route('internalorder.exportpdf') }}" class="btn btn-primary" target="_blank">CETAK PDF</a>
    ...
    <br></br>
            <div class="table-responsive" id="table-menu">
                    <table class="table data-table table-striped table-hover table-bordered" id="table_reporting"
                        data-url="{{ route('internalorder.index') }}" data-switchurl="{{ route('internalorder.status') }}" data-backurl="{{ route('internalorder.index') }}"
...
<script src="{{asset('js/master/internalorder/internalorder.js')}}"></script>
