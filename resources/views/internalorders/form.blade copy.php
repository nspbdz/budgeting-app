    ...
    <section class="card">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('internalorder.store') }}">
                ...
                @if(isset($ProjectByIO))
                    <input type="text" class="form-control" name="id" value="{{ $ProjectByIO->id }}" hidden>
                    <div class="row">
                    ...
                    @endif
                        ...
                        <!-- <div class="col-md-6">
                            ...
                            <select class="form-control" id="type" name="projectCode_select">
                ...
                <div class="row">
                        <div class="col-md-6">
                            <label> Project Code <span class="danger">*</span></label>
                            <select id="projectCode_select" name="projectCode_select" class="form-control col-md-12 @error('projectCode_select') is-invalid @enderror" style="width: 100% !important" id="rekening_kas_select">
                                <option value="0">Pilih Project Code</option>
                                @foreach ($projectCode as $itemProjectCode)
                                <option value="{{ $itemProjectCode->id }}">
                                            {{ $itemProjectCode->projectcode }}</option>
                                @endforeach
                            </select>
                                <!-- <div>
                                @error('projectCode_select')
