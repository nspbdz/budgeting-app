...
<div class="container">
    ...
    <form method="POST" id="search_form" class="form-horizontal">
        <div class="row">
            ...
            <div class="col-md-6 ">
                ...
                <a class="btn btn-xs btn-primary" href="{{ route('metodepembayaran.create') }}">
        ...
        <div class="btn-group float-right" style="margin-top: 15px;">
            <div class="text-right">
                <!-- <a class="btn btn-xs btn-primary" href="{{ route('metodepembayaran.create') }}"> <i
    ...
    <div class="table-responsive" id="table-menu">
        <table class="table data-table table-striped table-hover table-bordered" id="table_reporting"
            data-url="{{ route('metodepembayaran.index') }}"

            data-backurl="{{ route('metodepembayaran.index') }}" style="width: 100% !important" ">
        <thead>
            <tr>
            <th width=" 10%">#</th>
            <th>No. Kontrak</th>
