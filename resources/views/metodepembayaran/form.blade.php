...
<!-- <div class="row">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item"><a href="{{ route('metodepembayaran.index') }}"> {{ $title[1] }} </a></li>
    ...
    <section class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('metodepembayaran.store') }}">
                @csrf
...
<!--
            ...
            <th>Nilai Realisasi ADP </th> -->
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" name="nomorkontrak" value="{{ isset($project) ? $project['nomorkontrak'] : $id }}" hidden>

                            <input id="nomorkontrak" type="text" class="form-control @error('nomorkontrak') is-invalid @enderror"
                                name="nomorkontrak"
                                value="{{ isset($project) ? $project['nomorkontrak'] : $id }}"
                                required autocomplete="nomorkontrak" autofocus disabled>
                        ...
                        <!-- <div class="col-md-4">
                            <label>Nilai ADP <span class="danger"></span></label>
                            <input id="nilaiadp" type="text" class="form-control @error('nilaiadp') is-invalid @enderror"
                                name="nilaiadp"
                                value="{{ isset($project) ? $project['nilaiadp'] : $id }}"
                                required autocomplete="nilaiadp" autofocus>
                        ...
                        <div class="col-md-4">
                            ...
                            <input id="tahun" type="text" class="form-control @error('tahun') is-invalid @enderror"
                                name="tahun"
                                value="{{ isset($project) ? $project['tahun'] : $id }}"
                                required autocomplete="tahun" autofocus>
                ...
                @else
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label>Nama Metode Pembayaran <span class="danger">*</span></label>
...
<script src="{{ asset('js/master/project/metodepembayaran.js') }}"></script>
