    ...
    <!-- <form method="POST" id="search_form" class="form-horizontal">
        <div class="row">
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" placeholder="masukan Code Project" id="code" name="search">
            </div>
            <div class="col-md-6 ">
                <br>
                <div class="float-right">
                    <a class="btn btn-xs btn-primary" href="{{ route('department.create') }}">
                ...
                <button type="reset" class="btn btn-warning" data-toggle="tooltip" id="reset_form"
                 ...
                 <div class="float-right">
                    <a class="btn btn-xs btn-primary" href="{{ route('department.create') }}">
                        <img src="{{ asset('icons/addicon.svg') }}" alt="">
                        Department </a>
                        <a class="btn btn-warning" href="{{ route('department.export') }}">Export Department</a>
                        <a href="{{ route('department.exportpdf') }}" class="btn btn-primary" target="_blank">CETAK PDF</a>
                    </div>
                 </div>
            </div>
        </form>
          ...
          <br> </br>
            ...
            <div class="table-responsive" id="table-menu">
                    <table class="table data-table table-striped table-hover table-bordered" id="table_reporting"
                        data-url="{{ route('department.index') }}" data-switchurl="{{ route('department.status') }}" data-backurl="{{ route('department.index') }}"
