                ...
                <input type="text" class="form-control" name="id" value="{{ $user->id }}" hidden>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="departmenthead_select" name="departmenthead_select" class="form-control col-md-12 @error('departmenthead_select') is-invalid @enderror" style="width: 100% !important" id="departmenthead_select">
                                    ...
                                    @foreach ($userDepartment as $items)
                                    <option value="{{ $items->deptid }}"  {{  $items->id == $user->departmenthead ? 'selected' : '' }}>
                                ...
                                @elseif(empty($departmentHeadById))
                                    ...
                                    @foreach($userDepartment as $itemDepHead)
                                        <option value="{{ $itemDepHead->deptid }}" {{ old('departmenthead_select') == $itemDepHead->id ? "selected" :""}}>
                       ...
                       <div class="row">
                        ...
                        @if($userTeamLead->count() < 1)
    
                        <div class="col-md-6">
                                <label>Pilih Team Leader <span class="danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                ...
                                @if($teamLeadById != null)
                                <!--  -->
                                <select id="teamLeader_select" name="teamLeader_select" class="form-control col-md-12 @error('teamLeader_select') is-invalid @enderror" style="width: 100% !important" id="teamLeader_select">
                                    <option value="0">Pilih Team Leader</option>
                                    @foreach ($userTeamLead as $itemTeamLead)
                                    <option value="{{ $itemTeamLead->idUser }}"
                                    {{  $itemTeamLead->idUser == $teamLeadById->id ? 'selected' : '' }}>
                                    {{ $itemTeamLead->namadepan }}</option>
                                    @endforeach
                                </select>

                                @elseif($teamLeadById == null)
                                    ...
                                    <option value="0">Pilih Team Leader</option>
                                    @foreach($userTeamLead as $id => $itemTeamLead)
                                        <option value="{{ $itemTeamLead->idUser }}" {{ old('teamLeader_select') == $itemTeamLead->id ? "selected" :""}}>
                                                    {{ $itemTeamLead->namadepan }}</option>
                                    @endforeach
                                    </select>
                                    <div id="merah">* Data Sebelumnya Kosong <br> &nbsp; Atau Telah Di   Hapus </div>
                ...
                @else
                    ...
                    <!-- <label>New Confirm Password <span class="danger">*</span></label>
                         ...
                         <div class="col-md-6">
                            ...
                            <input id="confirm_password" type="password" class="form-control @error('confirm_password') is-invalid @enderror" class="form-control"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                          ...
                          <div class="col-md-6">
                            ...
                            <select id="departmenthead_select" name="departmenthead_select" class="form-control col-md-12 @error('departmenthead_select') is-invalid @enderror" style="width: 100% !important" >
                            <option value="0">Pilih Department Header</option>
                            @foreach($userDepartmentHead as $itemUserUserDepartmentHead)
                                <option value="{{ $itemUserUserDepartmentHead->departementid }}" {{ old('departmenthead_select') == $itemUserUserDepartmentHead->id ? "selected" :""}}>
