                ...
                <button type="reset" class="btn btn-warning" data-toggle="tooltip" id="reset_form"
                 ...
                 <div class="float-right">
                    <a class="btn btn-xs btn-primary" href="{{ route('asset.create') }}">
                        ...
                        Asset </a>
                        <a href="{{ route('asset.exportpdf') }}" class="btn btn-primary" target="_blank">CETAK PDF</a>
          ...
          <!-- <br> </br> -->
            ...
            <div class="table-responsive" id="table-menu">
                    <table class="table data-table table-striped table-hover table-bordered" id="table_reporting"
                        data-url="{{ route('asset.index') }}" data-switchurl="{{ route('asset.status') }}" data-backurl="{{ route('asset.index') }}"
...
<script src="{{asset('js/master/asset/asset.js')}}"></script>
<script>
