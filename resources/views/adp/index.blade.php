...
<!-- <div class="row">
    ...
    <div class="container">
        ...
        <!-- <div id="search" class="card-body pr-4 pl-4"> -->
    <br>
            ...
            <div class="col-md-2">
                ...
                <button type="reset" class="btn btn-warning" data-toggle="tooltip" id="reset_form"
                 ...
                 <div class="float-right">
                    <a class="btn btn-xs btn-primary" href="{{ route('adp.create') }}">
                        <img src="{{ asset('icons/addicon.svg') }}" alt="">
                        ADP </a>
                        <a href="{{ route('adp.exportpdf') }}" class="btn btn-primary" target="_blank">CETAK PDF</a>
          ...
          <!-- <br> </br> -->
            ...
            <div class="table-responsive" id="table-menu">
                    <table class="table data-table table-striped table-hover table-bordered" id="table_reporting"
                        data-url="{{ route('adp.index') }}" data-switchurl="{{ route('adp.status') }}" data-backurl="{{ route('adp.index') }}"
...
<script src="{{asset('js/master/adp/adp.js')}}"></script>
<script>
     $(document).ready(function() {
        ...
        $('#search').keyup(function(e){
            if(e.which == 13){//Enter key pressed
                $('#btn-pencarian').click();//Trigger search button click event
            }
        });
    });
</script>
