    ...
    <form method="POST" id="search_form" class="form-horizontal">
        ...
        <br></br>
            ...
            <div class="table-responsive" id="table-menu">
                    <table class="table data-table table-striped table-hover table-bordered" id="table_approval"
                        data-url="{{ route('approval.index') }}"  data-backurl="{{ route('approval.index') }}"
