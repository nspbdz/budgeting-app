                ...
                @if(isset($projectById))
                    ...
                    @else
                               <div class="col-md-6">
                                ...
                                <option value="{{ $users->id }}" {{ $users->id == $projectById->pic ? 'selected' : '' }}>{{ $users->namadepan }}</option>
                                    @endforeach
                                </select>
