...

{
    ...
    public function index(Request $request)
    {
        ...
        $title = ["Metode Pembayaran", "Metode Pembayaran", ""];
        ...
        if ($request->ajax()) {
          return Datatables::of($data)
                ...
                ->addColumn('action', function($row){
                    ...
                    $btn = '<a class="edit btn btn-icon btn-info detail-menu-btn" href="' . route('metodepembayaran.edit', $row['id']) . '" data-toggle="tooltip" data-placement="top" title="Detail Data">
                    <i class="bi bi-pencil-square" aria-hidden="true" id="detailArea"></i></a>';
                    $btn .= '<a class="edit btn btn-icon btn-info detail-menu-btn" href="' . route('metodepembayaran.show', $row['id']) . '" data-toggle="tooltip" data-placement="top" title="Detail Data">
      ...
      return view('metodepembayaran.index',['title' => $title,]);
    }
    ...
    public function create() {
      $title = ["Metode Pembayaran", "Metode Pembayaran", "Tambah Data"];

        // return view('metodepembayaran.form');
      return view('metodepembayaran.form',['title' => $title,]);

    }

    public function show($id) {
        $divisi = $this->getUProjectById($id);
        return view('metodepembayaran.show', ['divisi' => $divisi, ]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('metodepembayaran.form',['title' => $title,'project' => $project, ]);
    }
