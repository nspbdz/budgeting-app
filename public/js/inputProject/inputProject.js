...
$(function () {
    ...
    var table = $("#table_reporting").DataTable({
      ...
      createdRow: function( row, data, dataIndex ) {
        $( row ).find('td:eq(0)').attr('class', 'asd');
        $( row ).find('td:eq(1)').attr('class', 'asd');
        $( row ).find('td:eq(2)').attr('class', 'asd');
        $( row ).find('td:eq(3)').attr('class', 'asd');
        $( row ).find('td:eq(4)').attr('class', 'Project Code');
        $( row ).find('td:eq(5)').attr('class', 'IO');
        $( row ).find('td:eq(6)').attr('class', 'No. Formulir Permintaan');
        $( row ).find('td:eq(7)').attr('class', 'Permintaan Upload');
        $( row ).find('td:eq(8)').attr('class', 'Nama vendor');
        $( row ).find('td:eq(9)').attr('class', 'Status');

        // $( row ).find('td:eq(0)').attr('class', 'NO');
        // $( row ).find('td:eq(1)').attr('class', 'Action');
        // $( row ).find('td:eq(2)').attr('class', 'Nama Inisiatif');
        // $( row ).find('td:eq(3)').attr('class', 'Nama Pekerjaan');
        // $( row ).find('td:eq(4)').attr('class', 'Project Code');
        // $( row ).find('td:eq(5)').attr('class', 'IO');
        // $( row ).find('td:eq(6)').attr('class', 'No. Formulir Permintaan');
        // $( row ).find('td:eq(7)').attr('class', 'Permintaan Upload');
